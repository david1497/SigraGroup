...
class PartnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post partners_url, params: { partner: { p_link: @partner.p_link, p_name: @partner.p_name } }
    end
  ...
  test "should update partner" do
    patch partner_url(@partner), params: { partner: { p_link: @partner.p_link, p_name: @partner.p_name } }
